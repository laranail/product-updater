...
final class ProductUpdaterServiceProvider extends PackageServiceProvider
{
    ...
    public function configurePackage(Package $package): void
    {
        $package
            ...
            ->hasAboutSection(
                AboutSectionDefinition::make('Product Updater')
                    ->field('Version', fn (): string => (string) InstalledVersions::getPrettyVersion('laranail/product-updater'))
                    ->field('Channel', fn (): string => (string) config('product-updater.channel'))
            );
    }
